...
// $skills[0]["name"].$skills[0]["percent"];

$experience = [
    [
        'name' => 'JS and HTML,CSS',
        'started' => 2022,
    ],
    [
        'name' => 'Python',
...
$jobs = [
'job_name' => ['Freelance', 'GeoGlobe', 'Министерство Молодежи и Спорта'],
'job_data' => ['2020 - 2022', '2014 - 2015', '2012 - 2013'],
'job_desc' => ['Много интересной работы', 'Разная работа', 'Начало работы в IT']
]
        ...
        <div class="w3-row-padding">
                ...
                <div class="w3-white w3-text-grey w3-card-4">
                    ...
                    <div class="w3-container">
                        ...
                        <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>Город:
                            <?php echo $city; ?>, страна : <?php echo $country; ?></p>
            ...
            <div class="w3-twothird">
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        <?php for ($i = 0; $i < count($jobs["job_name"]); $i++):  ?>
                        <h5 class="w3-opacity"><b><?php echo $jobs["job_name"][$i]; ?></b></h5>
                        <h6 class="w3-text-teal"><i
                                class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs["job_data"][$i];?>
                        </h6>
                        <p><?php echo $jobs["job_desc"][$i]; ?></p>
                        <hr>
                        <?php endfor; ?>
                    </div>

                    <h2 class="w3-text-grey w3-padding-16"><i
                            class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт
                        программирования</h2>
                    ...
                    <div class="w3-container">
                        ...
                        <h6 class="w3-text-teal"><i
                                class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]["started"];?>
                        </h6>
                        <hr>
                        <?php endfor; ?>
                    </div>
